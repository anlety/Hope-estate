...
const CreateListing = () => {
  ...
  return (
    <main className='max-w-md px-2 mx-auto'>
      ...
      <form>
        <p className='text-lg mt-6 font-semibold'>Sell or Rent your property</p>
        <div className='flex'>
        ...
        <p className='text-lg mt-6 fo t-semibold'>Name</p>
        ...
        <div className='flex justify-between mb-6'>
          ...
          <div >
            ...
            <input type='number' id='bedroom' value={bedrooms} onChange={onChange} min="1" max="35" required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center'/>
          </div>
          <div >
            <p className='text-lg font-semibold'>Baths</p>
            <input type='number' id='bedroom' value={bathrooms} onChange={onChange} min="1" max="35" required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center'/>
          </div>
        ...
        { offer && (<div className='flex items-center mt-6'>
          <div>
